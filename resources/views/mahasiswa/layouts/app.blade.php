...
<body>
    ...
    <div class="d-flex sidebar flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 100vh; position: fixed; top:0;">
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li class="nav-item">
            <a href="/dashboard/user" class="{{Request::is('dashboard/user') ? 'active text-white' : ''}} nav-link link-dark">
              <i class="bi bi-person-circle" style="font-size: 1.2rem;"></i>
            Data User
          </a>
          </li>
          <li class="nav-item">
            <a href="/dashboard/admin" class="{{Request::is('dashboard/admin') ? 'active text-white' : ''}} nav-link link-dark">
